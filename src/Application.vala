 ...
 * SPDX-FileCopyrightText: 2021 Josip Antoliš <josip.antolis@protonmail.com>
 */
...
namespace GraniteWallpaperTestApp {
    ...
    public class Application : Gtk.Application {
        ...
        public Application () {
            Object(
                application_id: "com.github.Antolius.granite_welcome_test",
                flags: ApplicationFlags.FLAGS_NONE
            );

            saved_state = new GLib.Settings ("com.github.Antolius.granite_welcome_test.saved-state");
            ...
            // on the --help screen.
            set_option_context_summary (_("Granite Wallpaper Test App"));
            ...
            // on the --help screen.
            set_option_context_description (_("Copyright ⓒ 2021-present Josip Antoliš. Licensed under GNU GPL version 3.0."));
            ...
            handle_local_options.connect((application, options) => {
                ...
                if (options.contains("version")) {
                    print (@"Granite Wallpaper Test App $(Constants.Config.VERSION)\n");
